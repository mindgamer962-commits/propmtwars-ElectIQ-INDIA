...
import { MessageCircle, BrainCircuit, Landmark, HelpCircle, ChevronDown, Globe, Search, UserCheck, Loader2, LogIn, LogOut } from 'lucide-react';
...
const ComponentLoader = () => (
  <div className="flex flex-col items-center justify-center p-20 min-h-[400px]" role="alert" aria-busy="true">
    <Loader2 className="w-12 h-12 text-orange-500 animate-spin mb-4" />
    <p className="text-slate-500 font-bold tracking-widest uppercase text-xs">Loading Module...</p>
  </div>
);
  ...
  return (
    <div className="min-h-screen text-slate-100 font-outfit relative">
      <header>
        ...
        {/* Navigation */}
        <nav className="sticky top-0 z-40 bg-[#020617]/80 backdrop-blur-xl border-b border-white/5" role="navigation">
          <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
            ...
            <div className="hidden md:flex items-center gap-1 p-1 bg-white/5 rounded-2xl border border-white/10">
              <button 
                ...
                aria-current={activeMode === 'journey' ? 'page' : undefined}
              >
            ...
            <div className="flex items-center gap-4">
              {user ? (
                 <button 
                  ...
                  className="hidden lg:flex items-center gap-2 px-4 py-2 text-xs font-black uppercase text-slate-400 hover:text-white transition-colors"
                  aria-label="Logout"
                >
                ...
                <button 
                  onClick={handleLogin}
                  className="hidden lg:flex items-center gap-2 px-4 py-2 text-xs font-black uppercase text-orange-500 hover:text-orange-400 transition-colors"
        ...
        {/* Hero Section */}
        <div className="relative pt-24 pb-20 px-6 text-center">
          <motion.div
      ...
      <main className="max-w-7xl mx-auto px-6 pb-40">
        ...
        <section id="feedback-section" className="mt-40">
           <Suspense fallback={<ComponentLoader />}>
              <FeedbackSystem />
           </Suspense>
        </section>
      ...
      {/* ECI Resources Strip */}
      <aside className="bg-[#020617] py-24 text-white text-center border-t border-white/5" aria-label="Official Resources">
         <div className="max-w-4xl mx-auto px-6">
            <h3 className="text-3xl font-bold mb-8 italic">Official Civic Gateways</h3>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
               <a href="https://voters.eci.gov.in" target="_blank" rel="noopener noreferrer" className="p-8 bg-white/5 rounded-3xl border border-white/5 hover:bg-white/10 transition-all group">
               ...
               <a href="https://eci.gov.in/voter-education/" target="_blank" rel="noopener noreferrer" className="p-8 bg-white/5 rounded-3xl border border-white/5 hover:bg-white/10 transition-all group">
               ...
               <a href="https://affidavit.eci.gov.in" target="_blank" rel="noopener noreferrer" className="p-8 bg-white/5 rounded-3xl border border-white/5 hover:bg-white/10 transition-all group">
      ...
      {/* Footer */}
      <footer className="py-24 border-t border-white/5 bg-black/20" role="contentinfo">
        <div className="max-w-7xl mx-auto px-6 flex flex-col items-center">
           <div className="flex items-center gap-3 mb-8">
              <div className="w-10 h-10 bg-white/10 rounded-xl flex items-center justify-center text-white font-bold text-xl" aria-hidden="true">🇮🇳</div>
           ...
           <div className="pt-8 border-t border-white/5 w-full flex flex-col md:flex-row justify-between items-center gap-6">
              ...
              <div className="flex items-center gap-4">
                 <button className="p-3 bg-white/5 hover:bg-white/10 rounded-full text-slate-400 transition-all border border-white/5" aria-label="Toggle language">
                    <Globe size={20} />
                 </button>
